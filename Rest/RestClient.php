...
/**
 *
 * White Label POS Sample Implementation (POS SDK)
 *
 * @author Philipp von Criegern <admin@the-white-label.com>
 * @copyright 2019 Philipp von Criegern, WHite Label Ecommerce GmbH
